...
const pkg_up_1 = require("../compiled/pkg-up");
const tryPath_1 = require("./utils/tryPath");
const baseGenerator_1 = __importDefault(require("./utils/baseGenerator"));
const fs_extra_2 = require("fs-extra");
const installWithNpmClient_1 = require("./utils/installWithNpmClient");
...
const bootstrap = ({ args, cwd }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!args.default && args.install !== false) {
        (0, installWithNpmClient_1.installWithNpmClient)({ npmClient, cwd: target });
    }
    else {
